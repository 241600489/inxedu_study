...
public class UserDaoImpl extends GenericDaoImpl implements UserDao{
	...
	public void updateUserInfo(User user) {
		this.update("UserMapper.updateUserInfo",user);
	}
	public void updateClassIdByUserId(int userId,int classId){
		HashMap<String,String> map=new HashMap<>(2);
		map.put("userId",Integer.valueOf(userId).toString());
		map.put("classId",Integer.valueOf(classId).toString());
		this.update("UserMapper.updateClassIdByUserId",map);
	}
