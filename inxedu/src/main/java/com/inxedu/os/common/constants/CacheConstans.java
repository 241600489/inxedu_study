...
public class CacheConstans {
	...
	/** 前台登录用户ehcache前缀 */
	public static final long TIME_TO_LIVE_SECONDS = Long.parseLong(webPropertyUtil.getProperty("TIME_TO_LIVE_SECONDS"));//前台登录用户缓存24小时
	public static final long TIME_TO_IDLE_SECONDS = Long.parseLong(webPropertyUtil.getProperty("TIME_TO_IDLE_SECONDS"));//前台登录用户缓存24小时
	public static final int MAX_ELEMENTS_IN_MEMORY = Integer.parseInt(webPropertyUtil.getProperty("MAX_ELEMENTS_IN_MEMORY"));//前台登录用户缓存24小时
	...
	public static final int USER_TIME_LONG = Integer.parseInt(webPropertyUtil.getProperty("USER_TIME_LONG"));//前台登录用户缓存24小时
	...
	public static final String LOGIN_MEMCACHE_TEACHER = MEMFIX + "login_tea_user_";
