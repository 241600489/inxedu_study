			...
			<table style="line-height: 35px;">
				...
				<tr>
					...
					<td style="text-align: left;">
						...
						<input type="hidden" name="teacherIdArr"  />
						<div id="teacherList"></div>
						<a href="javascript:void(0)" onclick="selectTeacher()">选择老师</a>
						<input id="teacherId" type="hidden" name="course.teacherId"/>
					</td>
				</tr>
				<tr>
					<td>课程简介:</td>
				...
				<tr>
					<td>
						<font color="red">*</font>实验课id:
					</td>
					<td>
						<input name="course.labCourseId" style="width: 200px;" data-rule="required;"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<select name="course.type" style="width: 200px;" data-rule="required;">
							<option value="0">实验课</option>
				...
				<tr>
					...
					<td>
						<input name="course.memo" type="text" style="width: 200px;"/>
					</td>
				</tr>
