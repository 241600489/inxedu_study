...
<body>
<form action="/admin/stuClass/update">
    <input type="hidden" name="id" value="${stuClass.id}">
    <table align="center">
        <tr>
            <td>班级名称</td>
            <td><input type="text" name="className" value="${stuClass.className}" required></td>
        </tr>
        <tr>
            <td>详细信息</td>
            <td><input type="text" name="description" value="${stuClass.description}" required></td>
        </tr>
        <tr>
