...
function saveCourse() {
    ...
    var courseMaxNUmber = $("input[name='course.MaxNumber']").val();
    var courselectCount = $("input[name='course.selectCount']").val();
    var courseType = $("input[name='course.type']").val();
    var labCourseId = $("input[name='course.labCourseId']");
    if (!regs.test(courseMaxNUmber)) {
        alert("课容量必须是整数!");
        return false;
    }
    /*	if(!regs.test(courselectCount))
     {
     alert("选课人数必须是整数");
     return false;
     }*/
