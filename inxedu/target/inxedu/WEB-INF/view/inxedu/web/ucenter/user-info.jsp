						...
						<form method="post" id="updateForm">
							...
							<ol class="u-account-li">
								<li>
									...
									<input type="text" class="u-a-inpt" name="user.userName" value="${user.userName}" placeholder="" readonly="readonly">
								...
								<li>
									...
									<input type="text" class="u-a-inpt" name="user.no" value="${user.no}" placeholder="" readonly="readonly">
								...
								<li>
									...
									<input type="text" class="u-a-inpt" name="user.classname" value="${className}" placeholder="" readonly="readonly">
								</li>
						</ol>
						</form>
						<div class="ml50 mt50 pl50">
							<a href="javascript:void(0)" title="" class="comm-btn c-btn-7" onclick="updateUserInfo(${user.userId})">提 交</a>
						</div>
					</div>
					<!--修改头像，开始-->
