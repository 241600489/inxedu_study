...
<center><form action="/admin/examExcel/exportExamStudentAppointment" method="post">
...
<div class="mt20">
    <div class="commonWrap">
		<form action="/admin/examExcel/importExamStudentAppointment" method="post" id="importP" enctype="multipart/form-data">
